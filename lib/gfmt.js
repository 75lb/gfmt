...
@param {object[]} - column definitions
@alias module:gfmt
@example
> gfmt = require("gfmt")
> table = gfmt([
...
| 14 Jun 2015 | 110       |
*/
function gfmTable (data, columns) {
  columns = columns || []
  var options = { viewWidth: 50 }
  options.padding = { left: '| ', right: ' '}

  var table = columnLayout.table(data, options)
  var headerRow = {}
  table.columns.forEach(function (column) {
    var optionColumn = columns.find(function (optionColumn) {
  ...
  table = columnLayout.table(data, options)
  var separatorRow = {}
  table.columns.forEach(function (column) {
    separatorRow[column.name] = '-'.repeat(column.contentWidth)
  })
